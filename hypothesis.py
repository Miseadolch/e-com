...
if ((shapiro(days_purchases)[1] >= 0.05) and (shapiro(region_device)[1] >= 0.05)):
    ...
    #print(r)
    # p-value меньше 0.01 - взаимосвязь между типом устройства и кол-вом покупок в день есть
else:
...
if ((shapiro(days_purchases)[1] >= 0.05) and (shapiro(region_channel)[1] >= 0.05)):
    ...
    #print(r)
    # p-value меньше 0.01 - взаимосвязь между рекламным каналом и кол-вом покупок в день есть
else:
